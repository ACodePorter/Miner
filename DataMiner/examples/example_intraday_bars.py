...
class IntradayBarsExample:
    ...
    def start_monitoring(self):
        ...
        self.bars_manager.subscribe_intraday(self.sample_tickers, self.sample_intervals)
    ...
    def show_active_subscriptions(self):
        ...
        for interval in self.sample_intervals:
            active_tickers = self.bars_manager.get_active_intraday_tickers(interval)
            if active_tickers:
        ...
        for ticker in self.sample_tickers:
            for interval in self.sample_intervals:
                ...
                if bar_data:
                    ...
                    print(f"{ticker:<8} {interval:<6} {'No data':<20} {'N/A':<8} {'N/A':<8} {'N/A':<8} {'N/A':<8} {'N/A':<10}")
    ...
    def demonstrate_manual_fetching(self):
        ...
        # Get recent bars
        recent_bars = self.bars_manager.get_recent_bars(ticker, interval, count=5)
        ...
        historical_bars = self.bars_manager.get_bars(ticker, interval, period='5d')
    ...
    def stop_monitoring(self):
        ...
        self.bars_manager.unsubscribe_intraday(self.sample_tickers, self.sample_intervals)
