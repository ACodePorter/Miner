...
const ExtensionWarning: React.FC<ExtensionWarningProps> = React.memo(({ onDismiss }) => {
  ...
  return (
    <div className="fixed top-4 right-4 z-50 max-w-sm bg-accent-950/90 backdrop-blur-sm border border-accent-600/50 rounded-lg p-4 shadow-lg">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <ul className="mt-2 text-xs text-accent-300 space-y-1">
          ...
          <div className="mt-3 flex gap-2">
            <button
              ...
              className="text-xs bg-accent-600 hover:bg-accent-700 text-white px-3 py-1 rounded transition-colors"
            >
              Clear Cache
            </button>
            <button
              onClick={handleDismiss}
              className="text-xs bg-bg-tertiary hover:bg-bg-cardHover text-text-primary px-3 py-1 rounded transition-colors"
            >
              Dismiss
            </button>
          </div>
        ...
        <button
          onClick={handleDismiss}
          className="flex-shrink-0 text-accent-400 hover:text-accent-300"
        >
